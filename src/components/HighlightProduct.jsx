...
import { getWhatsAppLink, getPngBlobFromUrl, copyBlobToClipboard } from "../utils/whatsapp";
...
export default function HighlightProduct() {
  ...
  const generateLink = () => {
    ...
    const imgUrl = `https://florisstore.vercel.app${selectedProduct.images[modalImageIndex]}`;
