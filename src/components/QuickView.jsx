    ...
    >
      ...
      >
        ...
        <div className="flex-1 p-7 flex flex-col overflow-y-auto">
          ...
          {/* Size Badge */}
          <span className="inline-block self-start bg-blush text-charcoal text-xs font-medium px-3 py-1 rounded-full mb-4">
            Ukuran: {product.size}
          </span>

          {/* Price */}
          <p className="text-3xl font-bold text-rose-brand mb-4">
            {formatPrice(product.price)}
          </p>

          {/* Description */}
          <p className="text-muted text-sm leading-relaxed mb-6 flex-1">{product.description}</p>
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 bg-rose-brand hover:bg-rose-dark text-white font-medium py-3.5 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
          >
